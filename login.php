...
<?php include "components/header.php";
    ...
    // Check if the user is already logged in, then redirect to a different page
    if(isset($_SESSION['email'])) {
        header("Location: index.php"); // Redirect to the index or any other page
        exit;
    }
?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index-2.php" class="app-brand-link gap-2">
                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="POST">
                            ...
                            <div class="mb-3">
                                <input class="btn btn-primary d-grid w-100" type="submit" name="login" value="Sign in">
                            </div>
                        </form>
